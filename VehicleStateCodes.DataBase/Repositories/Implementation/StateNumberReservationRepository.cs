...
{
    public class StateNumberReservationRepository : GeneralRepository<StateNumberReservation>, IStateNumberReservationRepository
    {
        public StateNumberReservationRepository(Context context) : base(context)
        {
